...
<body>
	...
	<div class="container mt-5">
		...
		<form:form action="update/${id}" method="post" modelAttribute="todo">

			<div class="form-group">
				<form:input path="todoTitle" cssClass="form-control"
					placeholder="Todo Title"  value="${todo.todoTitle}"></form:input>

			</div>

			<div class="form-group">
				<form:textarea path="todoContent" cssClass="form-control"
					placeholder="Todo Content"  value = "${todo.todoContent}"></form:textarea>
			</div>
